...
def test_create_project_cmd(
    mock_create_project, mock_create_fields, mock_load_tasks, mock_add_tasks
):
    ...
    assert (
        "Project created successfully: https://github.com/orgs/me/projects/1"
        in result.output
    )
...
@patch("main.create_project_fields")
@patch("main.create_project")
def test_create_project_cmd_dry_run(
    mock_create_project, mock_create_fields, mock_load_tasks, mock_add_tasks
):
